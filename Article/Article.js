...
const articleCreate = siteContent => {
  ...
  p[0].textContent = siteContent.firstParagraph;
  p[1].textContent = siteContent.secondParagraph;
  p[2].textContent = siteContent.thirdParagraph;
